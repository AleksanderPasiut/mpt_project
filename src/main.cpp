...
static void initialize_session_manager(ServerFileApplication& fsapp, SessionManager& session_manager)
{
    fsapp.get_impl().register_on_post_handler("/initialize",
        [&session_manager](const std::string_view& contents, const std::string_view& cookie) -> CustomResponse
        {
            std::cout << "initialize\n";
...
int main(int argc, char* argv[])
{
    ...
    initialize_session_manager(fsapp, session_manager);
